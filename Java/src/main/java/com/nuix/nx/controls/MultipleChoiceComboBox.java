...
public class MultipleChoiceComboBox extends JPanel {
	...
	public MultipleChoiceComboBox() {
		...
		btnCheckAll.setIcon(new ImageIcon(MultipleChoiceComboBox.class.getResource("/com/nuix/nx/controls/accept.png")));
		...
		btnUncheckAll.setIcon(new ImageIcon(MultipleChoiceComboBox.class.getResource("/com/nuix/nx/controls/unaccept.png")));
