		...
		{
			{
				...
				btnClearFilter.setIcon(new ImageIcon(ChoiceTableControl.class.getResource("/com/nuix/nx/controls/zoom_out.png")));
				btnShowChecked.setToolTipText("Show all currently checked choices");
				btnShowChecked.setIcon(new ImageIcon(ChoiceTableControl.class.getResource("/com/nuix/nx/controls/tick.png")));
				...
				btnShowunchecked.setIcon(new ImageIcon(ChoiceTableControl.class.getResource("/com/nuix/nx/controls/cross.png")));
				...
				btnCheckDisplayed.setIcon(new ImageIcon(ChoiceTableControl.class.getResource("/com/nuix/nx/controls/accept.png")));
				...
				btnUncheckDisplayed.setIcon(new ImageIcon(ChoiceTableControl.class.getResource("/com/nuix/nx/controls/unaccept.png")));
				...
				btnSortup.setIcon(new ImageIcon(ChoiceTableControl.class.getResource("/com/nuix/nx/controls/arrow_up.png")));
				...
				btnSortdown.setIcon(new ImageIcon(ChoiceTableControl.class.getResource("/com/nuix/nx/controls/arrow_down.png")));
				...
				btnSortcheckedtotop.setIcon(new ImageIcon(ChoiceTableControl.class.getResource("/com/nuix/nx/controls/bullet_arrow_top.png")));
