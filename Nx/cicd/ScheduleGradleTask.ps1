...
$powershell_argument = "-NoProfile -NonInteractive -ExecutionPolicy Bypass -File $appdir\cicd\RunGradleTask.ps1 -appdir $appdir -gradleTask $gradleTask -taskParameters $taskParameters"
