		...
		{
			{
				...
				btnClearFilter.setIcon(new ImageIcon(DynamicTableControl.class.getResource("/icons/zoom_out.png")));
				btnShowChecked.setToolTipText("Show all currently checked choices");
				btnShowChecked.setIcon(new ImageIcon(DynamicTableControl.class.getResource("/icons/tick.png")));
				...
				btnShowunchecked.setIcon(new ImageIcon(DynamicTableControl.class.getResource("/icons/cross.png")));
				...
				btnCheckDisplayed.setIcon(new ImageIcon(DynamicTableControl.class.getResource("/icons/accept.png")));
				...
				btnUncheckDisplayed.setIcon(new ImageIcon(DynamicTableControl.class.getResource("/icons/unaccept.png")));
				...
				btnSortup.setIcon(new ImageIcon(DynamicTableControl.class.getResource("/icons/arrow_up.png")));
				...
				btnSortdown.setIcon(new ImageIcon(DynamicTableControl.class.getResource("/icons/arrow_down.png")));
				...
				btnAddRecord.setIcon(new ImageIcon(DynamicTableControl.class.getResource("/icons/add.png")));
				...
				btnRemoveSelected.setIcon(new ImageIcon(DynamicTableControl.class.getResource("/icons/delete.png")));
...
//					}
//				});
//				btnSortcheckedtotop.setIcon(new ImageIcon(DynamicTableControl.class.getResource("/icons/bullet_arrow_top.png")));
