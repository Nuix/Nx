...
# =====================================
checkable_tab = dialog.addScrollableTab("checkable_tab","Checkable Controls")

# Test scrollbars
100.times do |i|
	checkable_tab.appendCheckBox("check#{i.to_s.rjust(3,"0")}","Checkbox #{i+1}",true)
end
...
# ================================
text_tab = dialog.addScrollableTab("text_tab","Text Controls")
...
# ================================
file_tab = dialog.addScrollableTab("file_tab","File Controls")
...
# ===============================
choice_table_tab = dialog.addScrollableTab("choice_table_tab","Choice Table")
...
# ===========================================
other_tab = dialog.addScrollableTab("other_tab","Other Controls")
...
# ========================
radio_button_group_tab = dialog.addScrollableTab("radio_button_group_tab","Radio Button Group")
...
workers_tab = dialog.addScrollableTab("workers_tab","Workers")
...
traversal_settings_tab = dialog.addScrollableTab("traversal_settings_tab","Traversal Settings")
...
native_settings_tab = dialog.addScrollableTab("native_settings_tab","Native Settings")
...
text_settings_tab = dialog.addScrollableTab("text_settings_tab","Text Settings")
...
ocr_settings_tab = dialog.addScrollableTab("ocr_settings_tab","OCR Settings")
ocr_settings_tab.appendOcrSettings("ocr_settings")

# ==========================
# Test dynamic table control
# ==========================
dynamic_table_tab = dialog.addScrollableTab("dynamic_table_tab","Dynamic Table")
